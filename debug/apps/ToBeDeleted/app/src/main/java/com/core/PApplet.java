...
import com.a2d.PGraphicsAndroid2D;
import com.android.ActivityAPI;
import com.android.AppComponent;
import com.android.CompatUtils;
import com.data.*;
import com.event.*;
import com.opengl.*;
...
//        if (objects[i] == object && methods[i].equals(method)) {
   ...
   * <ul>
   * In addition, the new (for 2.0) com.event classes are passed to
  ...
  public void registerMethod(String methodName, Object target) {
    if (methodName.equals("mouseEvent")) {
      registerWithArgs("mouseEvent", target, new Class[] { com.event.MouseEvent.class });

    } else if (methodName.equals("keyEvent")) {
      registerWithArgs("keyEvent", target, new Class[] { com.event.KeyEvent.class });

    } else if (methodName.equals("touchEvent")) {
      registerWithArgs("touchEvent", target, new Class[] { com.event.TouchEvent.class });
...
//  }
   ...
   */
  public void postEvent(com.event.Event pe) {
    eventQueue.add(pe);
